...
with behind_the_scenes_col:
    ...
    st.write(
        "This demo illustrates looping over a list generated by a previous agent, feeding each entry in the list into another prompt. \
        Those results are then merged together in another prompt to generate a final answer. \
        When a user gives some input on what the generated story should be about, the first agent generates a list of characters for the story. \
        The workflow loops over that list of characters, generating a 'story arc' for each generated character. \
        The final agent uses those generated characters and generated story arcs to generate the final story."
    )
